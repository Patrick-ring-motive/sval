...
if (globalObj.Symbol) {
  !globalObj.Symbol.iterator && (globalObj.Symbol.iterator = createSymbol('iterator')) !globalObj.Symbol.asyncIterator && (globalObj.Symbol.asyncIterator = createSymbol('asynciterator'))
}
const win = create({})
...
export function getAsyncIterator(obj: any) {
  ...
  if (typeof Symbol === 'function') {
    iterator = obj[Symbol.asyncIterator] !iterator && (iterator = obj[Symbol.iterator])
  }
  if (iterator) {
